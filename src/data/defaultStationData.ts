import { Station, RawStationTaskTime, generateStationProcessingTimes } from '../utils/station';
...
const station1FoldingRawTimes: RawStationTaskTime[] = [
  ...
  { observedTimeTaken: 6.98, numberOfItems: 1, employeePerformance: 0.70, taskSize: 1 },
  { observedTimeTaken: 5.35, numberOfItems: 1, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 5.48, numberOfItems: 1, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 5.50, numberOfItems: 1, employeePerformance: 0.95, taskSize: 1 },
  { observedTimeTaken: 4.83, numberOfItems: 1, employeePerformance: 0.95, taskSize: 1 },
  
  // A6 folding (2 folds - medium complexity)
  { observedTimeTaken: 6.40, numberOfItems: 1, employeePerformance: 0.70, taskSize: 2 },
  { observedTimeTaken: 5.57, numberOfItems: 1, employeePerformance: 0.90, taskSize: 2 },
  { observedTimeTaken: 4.80, numberOfItems: 1, employeePerformance: 0.95, taskSize: 2 },
  { observedTimeTaken: 4.33, numberOfItems: 1, employeePerformance: 0.95, taskSize: 2 },
  { observedTimeTaken: 3.98, numberOfItems: 1, employeePerformance: 1.00, taskSize: 2 },
  { observedTimeTaken: 5.02, numberOfItems: 1, employeePerformance: 0.90, taskSize: 2 },
  
  // A7 folding (3 folds - most complex)
  { observedTimeTaken: 8.03, numberOfItems: 1, employeePerformance: 0.60, taskSize: 3 },
  { observedTimeTaken: 6.53, numberOfItems: 1, employeePerformance: 0.80, taskSize: 3 },
  { observedTimeTaken: 5.14, numberOfItems: 1, employeePerformance: 1.00, taskSize: 3 },
  { observedTimeTaken: 4.36, numberOfItems: 1, employeePerformance: 1.00, taskSize: 3 },
  { observedTimeTaken: 4.70, numberOfItems: 1, employeePerformance: 1.00, taskSize: 3 },
  { observedTimeTaken: 5.75, numberOfItems: 1, employeePerformance: 0.88, taskSize: 3 },
];
...
const station2StencillingRawTimes: RawStationTaskTime[] = [
  ...
  { observedTimeTaken: 119.24, numberOfItems: 5, employeePerformance: 0.50, taskSize: 1 },
  { observedTimeTaken: 93.57, numberOfItems: 5, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 87.97, numberOfItems: 5, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 85.25, numberOfItems: 5, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 92.22, numberOfItems: 5, employeePerformance: 0.90, taskSize: 1 },
  
  // Additional observations (second set)
  { observedTimeTaken: 93.00, numberOfItems: 5, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 84.00, numberOfItems: 5, employeePerformance: 0.90, taskSize: 1 },
  { observedTimeTaken: 73.00, numberOfItems: 5, employeePerformance: 0.80, taskSize: 1 },
  { observedTimeTaken: 75.00, numberOfItems: 5, employeePerformance: 1.00, taskSize: 1 },
  { observedTimeTaken: 68.00, numberOfItems: 5, employeePerformance: 1.00, taskSize: 1 },
];
...
const station3WritingRawTimes: RawStationTaskTime[] = [
  ...
  { observedTimeTaken: 51.70, numberOfItems: 1, employeePerformance: 0.8311, taskSize: 2 }, // 2-line verse
  { observedTimeTaken: 46.80, numberOfItems: 1, employeePerformance: 0.8718, taskSize: 2 },
  { observedTimeTaken: 45.41, numberOfItems: 1, employeePerformance: 0.9422, taskSize: 2 },
  { observedTimeTaken: 43.76, numberOfItems: 1, employeePerformance: 0.9403, taskSize: 2 },
  ...
  const stations: Station[] = [
    {
      ...
      batchCapacity: 1, // Process one at a time
      setupTime: 0,
    ...
    },
    {
      ...
      itemProcesingTime: { mean: 18, stdDev: 3 }, // Fallback
      sizeDistributions: new Map(),
      batchCapacity: 5, // Can process 5 at once
      setupTime: 30, // Some setup for stencils
      itemsLeftToProcessUntilIdle: 0,
      speedMultiplier: 1.0,
      generateProcessingTimes: function() {
        this.sizeDistributions = generateStationProcessingTimes(
    ...
    },
    {
      ...
      sizeDistributions: new Map(),
      batchCapacity: 1, // One writer at a time
      setupTime: 10,
      itemsLeftToProcessUntilIdle: 0,
      speedMultiplier: 1.0,
      generateProcessingTimes: function() {
